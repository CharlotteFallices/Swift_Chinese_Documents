...
请浏览[docs](/tree/m/docs)目录以获取有关编译器的更多信息,特别是[Debugging the Swift Compiler](/docs/DebuggingTheCompiler.rst)和[Continuous Integration for Swift](/docs/ContinuousIntegration.md)这两篇文档在提交您的第一个`Pull requests`时非常有用.
